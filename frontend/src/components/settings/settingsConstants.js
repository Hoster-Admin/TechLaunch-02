export const DRAFT_KEY = 'tlmena_draft_product';

export const WORLD_DIALS = [
...
export const WORLD_COUNTRIES = WORLD_DIALS.map(x => ({ v: x.c, l: `${x.f} ${x.n}` }));
...
export const labelStyle = { display:'block', fontSize:11, fontWeight:700, color:'#aaa', textTransform:'uppercase', letterSpacing:'.06em', marginBottom:7 };
export const inputStyle  = { flex:1, padding:'10px 14px', border:'none', fontSize:14, fontFamily:'Inter,sans-serif', outline:'none', color:'#0a0a0a', background:'transparent' };
export const fieldWrap   = { border:'1.5px solid #e8e8e8', borderRadius:10, overflow:'visible', background:'#fff', display:'flex', alignItems:'center', position:'relative' };
