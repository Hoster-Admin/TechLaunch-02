      ...
      <div style={{ paddingTop:'var(--nav-h)', minHeight:'100vh', background:'#fafafa' }}>
        ...
        <div className="page-header-section">
          <div className="page-header-inner">
            ...
            <p>Have an idea, feature request, or recommendation? We'd love to hear from you.</p>
          </div>
        </div>
        ...
        <div style={{ maxWidth:980, margin:'0 auto', padding:'48px 32px 80px', display:'grid', gridTemplateColumns:'1fr 300px', gap:40, alignItems:'start' }} className="contact-grid">
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
            <div style={{ background:'#fff', border:'1px solid #e8e8e8', borderRadius:16, padding:'24px 20px' }}>
              <div style={{ fontSize:13, fontWeight:800, marginBottom:14, color:'#1a1a1a' }}>💡 What to suggest</div>
              {[
                ['🚀','New features or improvements'],
                ['🌍','Content topics you want to see'],
                ['🤝','Partnerships or integrations'],
                ['🛠️','Bugs or issues you noticed'],
            ...
            <div style={{ background:'var(--orange-light)', border:'1px solid rgba(232,98,26,.15)', borderRadius:16, padding:'20px' }}>
              <div style={{ fontSize:13, fontWeight:800, color:'var(--orange)', marginBottom:8 }}>📬 How it works</div>
              <ul style={{ fontSize:12, color:'#555', lineHeight:1.9, paddingLeft:16, margin:0 }}>
                <li>Sign in to submit</li>
                <li>Team reviews every suggestion</li>
                <li>We respond where relevant</li>
                <li>Popular ideas shape our roadmap</li>
              </ul>
            </div>
          </div>
